...
Public Class BracketSheets
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RRWTApp.BracketSheets.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Divison() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedBracketSheets
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BracketSheets = New BracketSheets()
        rpt.Site = Me.Site
        Return rpt
    End Function
